...
function ejercicio1() {
    ...
    if(pesoPaquete > 0 && pesoPaquete < 2) {
        ...
        mensaje =`Paquete pesa ${pesoPaquete} \nValor despacho: ${Valor * pesoPaquete}CLP`
...
function ejercicio5(){
    ...
    let MENsaje = "";
    if (velocidad > 0 && velocidad < 15){
        MENsaje = `la velocidad del conductor es ${velocidad}Kilometros por hora clasificandose como una velocidad lenta`
    }else if (velocidad > 15 && velocidad < 20){`la velocidad del conductor es ${velocidad}Kilometros por hora clasificandose como una velocidad normal`
    }else if (velocidad > 20 && velocidad < 50){
        MENsaje =`la velocidad del conductor es ${velocidad}Kilometros por hora clasificandose como una velocidad rapida`
    }else{`la velocidad del conductor es ${velocidad}Kilometros por hora clasificandose como una velocidad por encima del limite`}
}
